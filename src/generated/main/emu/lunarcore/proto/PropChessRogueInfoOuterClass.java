...
public final class PropChessRogueInfoOuterClass {
  ...
  public static final class PropChessRogueInfo extends ProtoMessage<PropChessRogueInfo> implements Cloneable {
    ...
    /**
     * <code>optional bool enter_next_cell = 4;</code>
     */
    private boolean enterNextCell;

    /**
     * <code>optional bool AFLGOJIEAKE = 11;</code>
     */
    private boolean aFLGOJIEAKE;
    ...
    /**
     * <code>optional bool AFLGOJIEAKE = 11;</code>
     * @return whether the aFLGOJIEAKE field is set
     */
    public boolean hasAFLGOJIEAKE() {
     ...
     * @return this
     */
    public PropChessRogueInfo clearAFLGOJIEAKE() {
    ...
    /**
     * <code>optional bool AFLGOJIEAKE = 11;</code>
     * @return the aFLGOJIEAKE
     */
    public boolean getAFLGOJIEAKE() {
      return aFLGOJIEAKE;
    }

    /**
     * <code>optional bool AFLGOJIEAKE = 11;</code>
     * @param value the aFLGOJIEAKE to set
     * @return this
     */
    public PropChessRogueInfo setAFLGOJIEAKE(final boolean value) {
      bitField0_ |= 0x00000002;
      aFLGOJIEAKE = value;
      return this;
    }
    ...
    public PropChessRogueInfo mergeFrom(final PropChessRogueInfo other) {
      ...
      if (other.hasAFLGOJIEAKE()) {
        setAFLGOJIEAKE(other.aFLGOJIEAKE);
      }
      return this;
    }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasAFLGOJIEAKE() || aFLGOJIEAKE == other.aFLGOJIEAKE);
    }
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        ...
        output.writeBoolNoTag(aFLGOJIEAKE);
      }
    }
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        output.writeBool(FieldNames.aFLGOJIEAKE, aFLGOJIEAKE);
      }
      output.endObject();
    }
    ...
    public PropChessRogueInfo mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case 1130540388: {
            if (input.isAtField(FieldNames.aFLGOJIEAKE)) {
              if (!input.trySkipNullValue()) {
                aFLGOJIEAKE = input.readBool();
                bitField0_ |= 0x00000002;
              }
    ...
    static class FieldNames {
      ...
      static final FieldName aFLGOJIEAKE = FieldName.forField("AFLGOJIEAKE");
    }
  }
}
